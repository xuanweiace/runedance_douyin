...
func (p *GetMessageChatRequest) GetUserId() (v int64) {
	return p.UserId
}
...
func (p *GetMessageChatRequest) SetUserId(val int64) {
	p.UserId = val
}
...
func (p *GetMessageChatRequest) Field1DeepEqual(src int64) bool {
