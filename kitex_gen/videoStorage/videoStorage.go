...
type VideoStorageUploadRequest struct {
	VideoData []byte `thrift:"video_data,1,optional" frugal:"1,optional,binary" json:"video_data,omitempty"`
	VideoId   int64  `thrift:"video_id,2,required" frugal:"2,required,i64" json:"video_id"`
	CoverData []byte `thrift:"cover_data,3,optional" frugal:"3,optional,binary" json:"cover_data,omitempty"`
}

func NewVideoStorageUploadRequest() *VideoStorageUploadRequest {
	return &VideoStorageUploadRequest{}
}

func (p *VideoStorageUploadRequest) InitDefault() {
	*p = VideoStorageUploadRequest{}
}

var VideoStorageUploadRequest_VideoData_DEFAULT []byte

func (p *VideoStorageUploadRequest) GetVideoData() (v []byte) {
	if !p.IsSetVideoData() {
		return VideoStorageUploadRequest_VideoData_DEFAULT
	}
	return p.VideoData
}

func (p *VideoStorageUploadRequest) GetVideoId() (v int64) {
	return p.VideoId
}

var VideoStorageUploadRequest_CoverData_DEFAULT []byte

func (p *VideoStorageUploadRequest) GetCoverData() (v []byte) {
	if !p.IsSetCoverData() {
		return VideoStorageUploadRequest_CoverData_DEFAULT
	}
	return p.CoverData
}
func (p *VideoStorageUploadRequest) SetVideoData(val []byte) {
	p.VideoData = val
}
func (p *VideoStorageUploadRequest) SetVideoId(val int64) {
	p.VideoId = val
}
func (p *VideoStorageUploadRequest) SetCoverData(val []byte) {
	p.CoverData = val
}

var fieldIDToName_VideoStorageUploadRequest = map[int16]string{
	1: "video_data",
	2: "video_id",
	3: "cover_data",
}

func (p *VideoStorageUploadRequest) IsSetVideoData() bool {
	return p.VideoData != nil
}

func (p *VideoStorageUploadRequest) IsSetCoverData() bool {
	return p.CoverData != nil
}

func (p *VideoStorageUploadRequest) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VideoStorageUploadRequest[fieldId]), err)
SkipFieldError:
...
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_VideoStorageUploadRequest[fieldId]))
}

func (p *VideoStorageUploadRequest) ReadField1(iprot thrift.TProtocol) error {
...
func (p *VideoStorageUploadRequest) ReadField2(iprot thrift.TProtocol) error {
...
func (p *VideoStorageUploadRequest) ReadField3(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadBinary(); err != nil {
		return err
	} else {
		p.CoverData = []byte(v)
...
func (p *VideoStorageUploadRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("VideoStorageUploadRequest"); err != nil {
...
func (p *VideoStorageUploadRequest) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetVideoData() {
...
func (p *VideoStorageUploadRequest) writeField2(oprot thrift.TProtocol) (err error) {
...
func (p *VideoStorageUploadRequest) writeField3(oprot thrift.TProtocol) (err error) {
	if p.IsSetCoverData() {
...
func (p *VideoStorageUploadRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("VideoStorageUploadRequest(%+v)", *p)
}

func (p *VideoStorageUploadRequest) DeepEqual(ano *VideoStorageUploadRequest) bool {
	if p == ano {
		return true
...
func (p *VideoStorageUploadRequest) Field1DeepEqual(src []byte) bool {
...
func (p *VideoStorageUploadRequest) Field2DeepEqual(src int64) bool {
...
func (p *VideoStorageUploadRequest) Field3DeepEqual(src []byte) bool {
...
type VideoStorageService interface {
	UploadVideoToDB(ctx context.Context, req *VideoStorageUploadRequest) (r string, err error)
}
...
func (p *VideoStorageServiceClient) UploadVideoToDB(ctx context.Context, req *VideoStorageUploadRequest) (r string, err error) {
...
type VideoStorageServiceUploadVideoToDBArgs struct {
	Req *VideoStorageUploadRequest `thrift:"req,1" frugal:"1,default,VideoStorageUploadRequest" json:"req"`
}
...
var VideoStorageServiceUploadVideoToDBArgs_Req_DEFAULT *VideoStorageUploadRequest

func (p *VideoStorageServiceUploadVideoToDBArgs) GetReq() (v *VideoStorageUploadRequest) {
	if !p.IsSetReq() {
		return VideoStorageServiceUploadVideoToDBArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *VideoStorageServiceUploadVideoToDBArgs) SetReq(val *VideoStorageUploadRequest) {
	p.Req = val
}
...
func (p *VideoStorageServiceUploadVideoToDBArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewVideoStorageUploadRequest()
...
func (p *VideoStorageServiceUploadVideoToDBArgs) Field1DeepEqual(src *VideoStorageUploadRequest) bool {
...
var VideoStorageServiceUploadVideoToDBResult_Success_DEFAULT string

func (p *VideoStorageServiceUploadVideoToDBResult) GetSuccess() (v string) {
	if !p.IsSetSuccess() {
...
func (p *VideoStorageServiceUploadVideoToDBResult) Field0DeepEqual(src *string) bool {
