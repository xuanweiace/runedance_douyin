...
func (p *kMessageServiceClient) FavoriteAction(ctx context.Context, req *interaction.FavoriteRequest, callOptions ...callopt.Option) (r *interaction.FavoriteResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.FavoriteAction(ctx, req)
}

func (p *kMessageServiceClient) GetFavoriteList(ctx context.Context, req *interaction.GetFavoriteListRequest, callOptions ...callopt.Option) (r *interaction.GetFavoriteListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetFavoriteList(ctx, req)
}

func (p *kMessageServiceClient) CommentAction(ctx context.Context, req *interaction.CommentRequest, callOptions ...callopt.Option) (r *interaction.CommentResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CommentAction(ctx, req)
}

func (p *kMessageServiceClient) GetCommentList(ctx context.Context, req *interaction.GetCommentListRequest, callOptions ...callopt.Option) (r *interaction.GetCommentListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
